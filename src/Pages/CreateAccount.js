    ...
    <div className="flex flex-col items-center">
      ...
      <div className="w-full max-w-md sm:max-w-lg md:max-w-xl lg:max-w-2xl flex flex-col space-y-10 mx-auto px-6 py-4">
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-center">
              ...
              <label htmlFor="terms" className="ml-2 text-sm text-gray-700">
                Acepto los{" "}
                <a
                  href="https://burs.com.mx/terminos-y-condiciones"
                  target="_blank"
        ...
        <ul className="space-y-1 pl-2 font-rubik font-regular text-[10px]">
          <li
            className={`flex flex-row ${passwordChecks.isLongEnough ? "text-purple-heart-950" : "text-purple-heart-950/50"}`}
          >
            <div
              className={`w-3 h-3 mr-1 ${passwordChecks.isLongEnough ? "block" : "hidden"}`}
            >
          ...
          <li
            className={`flex flex-row ${passwordChecks.hasLowerCase ? "text-purple-heart-950" : "text-purple-heart-950/50"}`}
          >
            <div
              className={`w-3 h-3 mr-1 ${passwordChecks.hasLowerCase ? "block" : "hidden"}`}
            >
              <img src={thickIcon} alt="icon" />
            </div>
          ...
          <li
            className={`flex flex-row ${passwordChecks.hasUpperCase ? "text-purple-heart-950" : "text-purple-heart-950/50"}`}
          >
            <div
              className={`w-3 h-3 mr-1 ${passwordChecks.hasUpperCase ? "block" : "hidden"}`}
            >
              <img src={thickIcon} alt="icon" />
            </div>
          ...
          <li
            className={`flex flex-row ${passwordChecks.hasNumber ? "text-purple-heart-950" : "text-purple-heart-950/50"}`}
          >
            <div
              className={`w-3 h-3 mr-1 ${passwordChecks.hasNumber ? "block" : "hidden"}`}
            >
              <img src={thickIcon} alt="icon" />
            </div>
          ...
          <li
            className={`flex flex-row ${passwordChecks.hasSpecialChar ? "text-purple-heart-950" : "text-purple-heart-950/50"}`}
          >
            <div
              className={`w-3 h-3 mr-1 ${passwordChecks.hasSpecialChar ? "block" : "hidden"}`}
            >
              <img src={thickIcon} alt="icon" />
            </div>
        ...
        <ReCAPTCHA
          sitekey={
            import.meta.env.VITE_RECAPTCHA_SITEKEY || "recaptcha-sitekey"
          }
        ...
        <div className="flex justify-center">
          <Button
            ...
            isDisabled={
              !recaptchaValue || Object.keys(errors).length > 0 || isSubmitting
            }
        ...
        <div className="flex flex-col items-start w-10/12">
          <p className="font-rubik font-light text-sm text-dark-blue-950">
            ...
            <a className="text-dark-blue-700 font-normal" href={LOGIN}>
              {" "}
              Inicia Sesión
            </a>
          </p>
