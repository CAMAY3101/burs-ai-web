...
const backgroundIconClass = "bg-dark-blue-100 rounded-full flex items-center justify-center w-24 h-24 md:w-24 md:h-24 lg:w-28 lg:h-28"
const sizeIcon = "w-16 h-16 md:w-16 md:h-16 lg:w-20 lg:h-20"
